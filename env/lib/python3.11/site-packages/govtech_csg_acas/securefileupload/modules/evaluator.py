...
def evaluate(file, request):
    ...
    if not (strict_val_success and possible_attack_val_success):
        ...
        upload_errmsg = upload_errmsg + \
            ' File: [' + file.basic_information.name + '] ' + 'ERROR: '
        ...
        logger.warning(
            "[Evaluator module] - Blocking: Strict evaluation FAILED")
    else:
    ...
    if not yara_val_success:
        ...
        logger.warning(
            "[Evaluator module] - Blocking: YARA evaluation FAILED")
    else:
    ...
    if not clamav_val_success:
        ...
        logger.warning(
            "[Evaluator module] - Blocking: Quicksand evaluation FAILED")
    else:
    ...
    if not clamav_val_success:
        ...
        logger.warning(
            "[Evaluator module] - Blocking: clamAV evaluation FAILED")
    else:
